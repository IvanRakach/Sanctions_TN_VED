...
class SanctionsTnvedCodes(models.Model):
    sanctions_tn_ved_code = models.CharField('CN код', max_length=200, db_index=True)
    ...
    country_code_2_dig_1side = models.CharField('Страна отправления', max_length=2)
    country_code_2_dig_2side = models.CharField('Страна назначения', max_length=2)
    sanctions_initiator_country_code_2_dig = models.CharField('Страна, которая ввела санкции', max_length=2)
    export_import_ru = models.CharField('Экспорт в РФ / Импорт в РФ', max_length=12)
...
class SanctionsTnvedCodesFromRU311312313BY147(models.Model):
    sanctions_tn_ved_code = models.CharField('Код ТН ВЭД ЕАЭС', max_length=10, db_index=True)
...
class SanctionCountriesListFromRU313(models.Model):
    sanction_country_rus = models.CharField('Наименование страны', max_length=20)
    sanction_country_iso_alpha_2 = models.CharField('Alpha-2 ISO 3166-1', max_length=2, db_index=True)
    sanction_country_iso_alpha_3 = models.CharField('Alpha-3 ISO 3166-1', max_length=3, db_index=True)
